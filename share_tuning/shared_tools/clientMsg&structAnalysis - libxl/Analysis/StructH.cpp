...
void StructHCPP::AnalysisStructMsg(libxl::Book* book)
{
	CString url;
	...
	{	
		...
		for (int j=0; j<nCol; ++j)
		{
			...
			case libxl::CELLTYPE_NUMBER:
				...
				iNum = Round(iNum);
				strValue = StructvalueToString(iNum).c_str();
				break;
...
void StructHCS::AnalysisStructMsg(libxl::Book* book)
{
	CString url;
...
std::string StructH::StructvalueToString(double value)
{
	char buffer[32];
...
double StructH::Round(double value)
{
