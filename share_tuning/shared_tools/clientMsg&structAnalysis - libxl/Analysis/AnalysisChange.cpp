...
void Analysis::AnalysisClientMsg(libxl::Book* book)
{
	if (m_pClientMsg)
		m_pClientMsg->AnalysisClientMsg(book);
}
void Analysis::AnalysisStructMsg(libxl::Book* book)
{
	if (m_pStruct)
		m_pStruct->AnalysisStructMsg(book);
}
