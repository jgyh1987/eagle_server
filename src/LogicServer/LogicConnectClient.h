#ifndef _LOGIC_CONNECTCLIENT_H_
#define _LOGIC_CONNECTCLIENT_H_
...
class CLogicConnectClient : public CServerConnectClientEx
{
public:
    CLogicConnectClient(const std::string &name, uint32_t serverType, uint32_t serverId, const std::string &ip = "127.0.0.1",const unsigned short port = 18057, uint32_t queuesize = 102400)
...
template<class cmd>
unsigned char* CLogicConnectClient::ServerCmdBuffer(cmd* &name) {
    m_sendBuffer.ReSet();
